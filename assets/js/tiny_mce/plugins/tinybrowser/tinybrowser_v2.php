...
if(!$standalone && $tinybrowser['integration']=='tinymce')
	...
	{
	?><link rel="stylesheet" type="text/css" media="all" href="/js/tiny_mce/plugins/tinybrowser/css/stylefull_tinybrowser.css" /><?php 
	}
?>
<link rel="stylesheet" type="text/css" media="all" href="/js/tiny_mce/plugins/tinybrowser/css/style_tinybrowser.css.php" />
...
<script type="text/javascript">
	function loadContent(elementSelector, sourceURL) {
		$(""+elementSelector+"").load("http://<?= $_SERVER['SERVER_NAME'] ?>/js/tiny_mce/plugins/tinybrowser/"+sourceURL+"");
	}
</script>
...
<div class="tabs">
	<ul>
		<li id="browse_tab"><span><a href="javascript:loadContent('#content', 'tinybrowser.php?type=<?php echo $typenow.$passfolder.$passfeid; ?>');"><?php echo TB_BROWSE; ?></a></span></li>

		<?php if ($tinybrowser['allowupload']): ?>
			<li id="upload_tab"><span><a href="javascript:loadContent('#content', 'upload.php?type=<?php echo $typenow.$passfolder.$passfeid; ?>');"><?php echo TB_UPLOAD; ?></a></span></li>
		<?php endif ?>

		<?php if ($tinybrowser['allowedit'] || $tinybrowser['allowdelete']): ?>
			<li id="edit_tab"><span><a href="javascript:loadContent('#content', 'edit.php?type=<?php echo $typenow.$passfolder.$passfeid; ?>');"><?php echo TB_EDIT; ?></a></span></li>
		<?php endif ?>
	
		<?php if ($tinybrowser['allowfolders']): ?>
			<li id="folders_tab"><span><a href="javascript:loadContent('#content', 'folders.php?type=<?php echo $typenow.$passfolder.$passfeid; ?>');"><?php echo TB_FOLDERS; ?></a></span></li>
		<?php endif ?>

		<?php if (count($browsedirs) > 1): ?>
			<li id="folder_tab" class="right"><span>
		<?php endif ?>
		
		<?php form_select($browsedirs,'folder',TB_FOLDERCURR,urlencode($foldernow),true);?>
		</span></li>
	</ul>
</div>
</form>
