$(document).ready(function() {
	...
	var $calendar = $('#calendar').weekCalendar({
		...
		data: function(start, end, callback) {
			...
			$.getJSON("/admin/kidsclub/json/"+dataSource, function(result) { callback(result) });
        }
	});
   ...
   $("select[name='start']").change(function(){
	...
	function save() {
		$.post("/admin/kidsclub/insert/",
		{
			"schedule_id": $("#schedule_id").val(),
			"club_id": $("#data_source").val(),
			"start": $("#start").val(),
			"end": $("#end").val(),
			"title": $("#title").val(),
			"body": $("#body").val()
