...
(function($) {
    ...
    $.widget("ui.weekCalendar", {
        ...
        _renderCalendar : function() {
            ...
            if(options.buttons) {
                calendarNavHtml = "<div class=\"calendar-nav float-right\" style=\"margin: -30px 0 0 0;\">\
                    <button class=\"today button-secondary\">" + options.buttonText.today + "</button>\
                    <button class=\"next button-secondary\">" + options.buttonText.nextWeek + "</button>\
					<button class=\"prev button-secondary\">" + options.buttonText.lastWeek + "</button>\
